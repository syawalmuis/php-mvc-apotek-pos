                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <form name="form-src" id="form-src">
                            <input type="text" name="search-usr" id="search-member" class="form-control form-control-sm"
                                placeholder="Search">
                        </form>
                    </div>
                    <div class="col-sm-3">
                        <form action="" id="form-cat">
                            <div class="form-group mr-1">
                                <select name="category" id="category"
                                    class="form-control form-control-sm category-member">
